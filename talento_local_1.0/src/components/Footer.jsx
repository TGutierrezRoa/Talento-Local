        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Conectamos profesionales calificados con personas que necesitan servicios de calidad.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/servicios/carpinteros" className="text-gray-400 hover:text-orange-500">
                  Carpinteros
                </Link>
              </li>
              <li>
                <Link to="/servicios/jardineros" className="text-gray-400 hover:text-orange-500">
                  Jardineros
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/como-funciona" className="text-gray-400 hover:text-orange-500">
                  Cómo Funciona
                </Link>
              </li>
              <li>
